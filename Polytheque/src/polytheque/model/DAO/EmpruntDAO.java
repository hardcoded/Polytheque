...
public class EmpruntDAO extends DAO 
{
	...
	public boolean create(Date dateDebut, Date dateFin, Reservation reservation, Adherent adherent, Jeu jeu, Extension extension) 
	{
		try 
		{
			...
			PreparedStatement psInsert = connection.prepareStatement("INSERT INTO "
					...
					+ "VALUES (?, ?, ?, ?, ?, ?, ?)");
			// On n'ajoute pas l'ID car il s'incr√©mente automatiquement dans la base de donn√©es
	...
	/**
	 * suppression de la reservation par son id dans la base de donnÈes
	 * @param id
	 * @return
	 */
	...
	/**
	 * resupere un emprunt avec son id ‡ partir de la base de donnÈes
	 * @param idEmprunt
	 * @return
	 */
