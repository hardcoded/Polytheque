...
public class AffichageListeJeux extends JPanel implements ActionListener {
	...
	private void ajouterLesBoutons() {
		...
		this.boutonAjouterJeu.setBounds(800, 200, 400, 30);
		this.boutonAjouterJeu.setFocusable(false);
		this.boutonAjouterJeu.addActionListener(this);
		this.add(this.boutonAjouterJeu);
		
		this.boutonModifierJeu = new JButton("Modifier un jeu");
		this.boutonModifierJeu.setBounds(800, 400, 400, 30);
		this.boutonModifierJeu.setFocusable(false);
		this.boutonModifierJeu.addActionListener(this);
		this.add(this.boutonModifierJeu);
		
		this.boutonSupprimerJeu = new JButton("Supprimer un jeu");
		this.boutonSupprimerJeu.setBounds(800, 600, 400, 30);
		this.boutonSupprimerJeu.setFocusable(false);
		this.boutonSupprimerJeu.addActionListener(this);
		this.add(this.boutonSupprimerJeu);
