...
public class AffichageModificationAdherent extends JPanel implements ActionListener {
	...
	/**
	 * Creation de la page permettant de modifier les informations d'un adh�rent en particulier.
	 * 
	 * @param afficheAppli
	 *      Une tache d'affichage de l'application.
	 * @param adherent
	...
	public void ajouterChamps() {
		...
		JLabel labelUserPasRecup = new JLabel("Compteur non r�cup�r� :");
	...
	/**
	 * Cr�er le bouton permettant de choisir la date de naissance de l'utilisateur.
	 */
		...
		if (boutonSelectionne == this.boutonValider) {
			if (this.userName.getText() != null && this.userFirstName.getText() != null && 
				...
				if (this.tacheDAffichageDeLApplication.modifAdherent(adherent) == false) {
					this.tacheDAffichageDeLApplication.afficherMessage("Erreur lors de la modification de l'adh�rent", "Erreur de modification", JOptionPane.ERROR_MESSAGE);
				}
				else {
