...
public class HomePage extends JTabbedPane {
	...
	public HomePage(TacheDAffichage afficheAppli){
		...
		this.addTab("RÈserver Jeu", this.tacheDAffichageDeLApplication.afficherEcranReservationJeux());
		this.addTab("RÈserver Extension", this.tacheDAffichageDeLApplication.afficherEcranReservationExtension());
		...
		if (this.tacheDAffichageDeLApplication.adherentAdmin()) {
			...
			this.addTab("AdhÈrents", this.tacheDAffichageDeLApplication.afficherGestionAdherent());
			this.addTab("RÈservations", this.tacheDAffichageDeLApplication.afficherListeReservations());
		}
