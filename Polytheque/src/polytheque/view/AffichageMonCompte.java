...
public class AffichageMonCompte extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (boutonSelectionne == this.boutonValider)
		{
			...
			this.tacheDAffichageDeLApplication.afficherMessage("Vos modifications ont bien ete prises en compte !", "Modification termin̩e", JOptionPane.INFORMATION_MESSAGE);
