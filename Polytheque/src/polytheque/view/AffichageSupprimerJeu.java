		...
		if (boutonSelectionne == this.boutonValider) {
			if (this.gameNom.getText() != null) {
				...
				if (this.tacheDAffichageDeLApplication.supprimerJeu(idJeu) ==  false) {
					this.tacheDAffichageDeLApplication.afficherMessage("Probl�me lors de la suppression du jeu !", "Erreur suppression", JOptionPane.ERROR_MESSAGE);
				}
				else {
					this.tacheDAffichageDeLApplication.afficherMessage("Jeu supprim� avec succ�s !", "Suppression effectu�e", JOptionPane.INFORMATION_MESSAGE);
				}
			}
			else {
