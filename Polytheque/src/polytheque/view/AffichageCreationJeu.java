...
/**
 * Classe permettant de cr�er un nouveau jeu.
 * 
...
public class AffichageCreationJeu extends JPanel implements ActionListener {
	...
	/**
	 * Creation de la page permettant de cr�er un nouveau jeu.
	 * 
	 * @param afficheAppli
	 *            Une tache d'affichage de l'application.
	 */
	 ...
	 * les zones de textes seulement lisible ainsi que le bouton d�roulant.
	 */
	public void ajouterChamps() {		
		JLabel titrePrincipal = new JLabel("Cr�ation d'un Jeu");
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (boutonSelectionne == this.boutonValider) {
			if (this.gameNom.getText() != null && this.gameNBEx.getText() != null && 
					this.gameEditeur.getText() != null && this.gameAnnee.getText() != null && 
					this.gameAge.getText() != null && this.gameJouMin.getText() != null) {
				String statut;
				...
				if (this.tacheDAffichageDeLApplication.creerJeu(jeu) == false) {
					this.tacheDAffichageDeLApplication.afficherMessage("Erreur lors de la cr�ation d'un nouveau jeu", "Erreur de cr�ation", JOptionPane.ERROR_MESSAGE);
				}
				else {
					this.tacheDAffichageDeLApplication.afficherMessage("Un nouveau jeu a �t� cr�� !", "Cr�ation termin�e", JOptionPane.INFORMATION_MESSAGE);
					return;
				}
			}
			else {
