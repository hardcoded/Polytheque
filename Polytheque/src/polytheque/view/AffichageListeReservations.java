...
public class AffichageListeReservations extends JPanel implements ActionListener {
	...
	private TacheDAffichage tacheDAffichageDeLApplication; //classe ou toutes les fonctions utiles � l'affichage sont �crites
	private ModeleTableauReservations tableauReservations; //donne le modele � suivre pour le tableau

	private JTextField searchContent; //champ permettant d'�crire
	...
	/**
	 * m�thode qui permet de traiter les �v�nements (les cliques sur boutons)
	 */
	@Override
	public void actionPerformed(ActionEvent e) {
		...
		if (boutonSelectionne == this.boutonValiderReservation) {
			this.tacheDAffichageDeLApplication.afficherMessage("Fonctionnalit� non disponible", "Erreur",0);
		}
